...
На этом этапе Anaconda Prompt начал выдавать ошибки, вероятнее всего связанные с конфликтом двух версий Питона. Поскольку сносить свой актуальный Питон я не хочу, он мне нужен для других проектов, я решила остановиться на достигнутом и нничего не дорабатывать.

## Выводы
Я познакомилась с программными средствами для создания системы машинного обучения и ее интеграции в Unity. В данной лабораторной работе я создадала ML-агент и натренировала  нейросеть, задача которой заключается в управлении шаром. Задача шара заключается в том, чтобы оставаясь на плоскости находить кубик, смещающийся в заданном случайном диапазоне координат.
